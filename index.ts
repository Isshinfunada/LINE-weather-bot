...
async function sendLineMessage(message: string, userId?: string): Promise<any> {
...
// APIエンドポイント
app.get('/', (c) => {
  return c.text('LINE Weather Bot with MCP Server is running! 🌧️');
});
...
console.log('LINE MCP Serverを使用しています');
